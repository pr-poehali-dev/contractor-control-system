...
const ObjectInfoBar = ({ object, className = '', compact = false, onBack }: ObjectInfoBarProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`w-full bg-slate-50 border-b border-slate-200 px-4 py-3 flex items-center gap-3 hover:bg-slate-100 transition-colors cursor-pointer text-left ${className}`}
    >
