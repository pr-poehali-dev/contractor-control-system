...
const ObjectInfoBar = ({ object, className = '', compact = false, onBack }: ObjectInfoBarProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`w-full bg-gradient-to-b from-white to-slate-50/50 border-b border-slate-200 px-4 py-4 flex items-start gap-3 hover:bg-slate-50 transition-all cursor-pointer text-left ${className}`}
    >
