...
const ObjectInfoBar = ({ object, className = '', compact = false, onBack }: ObjectInfoBarProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`w-full bg-gradient-to-b from-white to-slate-50/50 px-6 py-[22px] flex items-center gap-4 hover:bg-slate-50 transition-all cursor-pointer text-left ${className}`}
    >
