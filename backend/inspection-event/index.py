...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        if method == 'GET':
            inspection_id = event.get('queryStringParameters', {}).get('inspection_id')
        ...
        if method == 'POST':
            ...
            inspection_id = body_data.get('inspection_id')
            ...
            cur.execute("""
                ...
                VALUES (%s, %s, %s, %s)
                RETURNING *
            """, (inspection_id, event_type, created_by, json.dumps(metadata)))
