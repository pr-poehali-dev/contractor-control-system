-- Создаём организацию для пользователя id=29 с временным ИНН
...
SELECT 29, id, 'admin' FROM t_p8942561_contractor_control_s.organizations ORDER BY id DESC LIMIT 1;
